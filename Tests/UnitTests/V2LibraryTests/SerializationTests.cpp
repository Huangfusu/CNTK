...
void TestCheckpointingWithStatefulNodesAndExplicitSeeds()
{
    auto featureStreamName = L"features";
    auto labelsStreamName = L"labels";
...
BOOST_AUTO_TEST_CASE(CheckpointingWithStatefulNodesAndExplicitSeeds)
{
     TestCheckpointingWithStatefulNodesAndExplicitSeeds();
}
